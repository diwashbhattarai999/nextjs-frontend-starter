import { PageFooter } from "@/components/shared/page";
import { Section, SectionContent, SectionHeader, SectionTitle } from "@/components/shared/section";
...
export function LandingFooter() {
    ...
    return (
        <PageFooter className="mt-4">
            <Section spacing="sm">
                <SectionContent className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col gap-3">
                        <SectionHeader className="gap-3">
                            <SectionTitle className="text-sm">{footer.product}</SectionTitle>
                        </SectionHeader>
                        <nav aria-label={footer.product} className="flex flex-col gap-2">
                            ...
                            <FooterLink href={ROUTES.DASHBOARD.SETTINGS}>
                                {footer.settings}
                            </FooterLink>
                            <FooterLink href={ROUTES.DASHBOARD.PROFILE}>
                                {footer.profile}
                            </FooterLink>
                    ...
                    <div className="flex flex-col gap-3">
                        <SectionHeader className="gap-3">
                            <SectionTitle className="text-sm">{footer.legal}</SectionTitle>
                        </SectionHeader>
                    ...
                    <div className="flex flex-col gap-3">
                        <SectionHeader className="gap-3">
                            <SectionTitle className="text-sm">{footer.resources}</SectionTitle>
                        </SectionHeader>
